...
\startplacefigure
  \externalfigure[35_2.pdf]
\stopplacefigure

The angle $t$ is in radians. It is known from geometry that following equalities hold:
$$S_\Delta OAP = \frac{1}{2}OA.OP.\sin t = \frac{1}{2}\sin t\text{ for unit circle}$$
$$S_\Delta OAQ = \frac{1}{2}OA.AQ = \frac{1}{2}\tan t$$
$$S_\Delta OAEP = \frac{1}{2}t$$

Clearly, $\sin t < t < \tan t\Rightarrow \cos t < \frac{\sin t}{t} < 1$.
...
\item Solve the inequality $\frac{5}{4}\sin^2x + \frac{1}{4}\sin^22x > \cos2x$.
\item Solve the inequality $5 + 2\cos2x\leq 3|2\sin x - 1|$.
\item Solve the inequality $\sin^6x + \cos^6x > 13/16$.
\item Solve the inequality $\sin2x + \tan x\geq 2$.
\stopitemize
