...
take up a bachelor's course where knowledge of trigonometry is required.  I will try to cover as much as I can and
will keep adding new material over a long period.
...
Every chapter will have theory. Read
...
your work and I will try to answer to the best of my ability. However, if you have a local expert seek his/her advice first.
...
Since this book is written for self study anyone with interest in trigonometry can read it. That does not mean that school or college
...
You should have knowledge till grade 8th course. Attempt has been made to keep it simple and give as much as background to the
...
The goal of for reading this book is becoming proficient in solving simple and basic problems of trigonometry. Another goal would be to
...
packages and work very nicely. Asymptote in particular is very nice for 3d-drawings
and linear equation solving. I have yet to learn Metafun which comes with~\ConTeXt{}.

I would like to thank my parents, wife, son and daughter for taking out their fair share
...
go. Richard Stallman is the first, Donald Knuth, Edger Dijkstra, John von Neumann after
that as their lives have strong influence in
...
\useurl[github][https://github.com/shivshankardayal/Trigonometry-Context][][https://github.com/shivshankardayal/Trigonometry-Context]
...
those by email or create a PR on github. The github url is \from[github].

\rightaligned{Shiv Shankar Dayal}\\
